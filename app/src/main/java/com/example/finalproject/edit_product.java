...
public class edit_product extends AppCompatActivity {
    ...
    String myselectedTM;
    public static String EDIT_CATEGORY_KEY = "editcatkey";
    public static String EDIT_TRADEMARK_KEY= "editTMkey";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_product);
        catsp = (Spinner)findViewById(R.id.edit_search_by_cat);
        TMsp = (Spinner)findViewById(R.id.edit_search_by_TM);

        btn_main = (Button)findViewById(R.id.edit_btn_main);
        btn_search = (Button)findViewById(R.id.edit_search_btn);
        ...
        TMsp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                btn_search.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(getBaseContext() , Edit_Search_Result.class);
                        intent.putExtra(EDIT_CATEGORY_KEY , MySelCat);
                        intent.putExtra(EDIT_TRADEMARK_KEY , myselectedTM);
                        startActivity(intent);
                    }
                });
            }
