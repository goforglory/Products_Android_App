...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ProductsViewHolder> {

    ArrayList<Products> products ;
    Context context;
    private selectedPro pro;

    public RecyclerAdapter(ArrayList<Products> products , Context context , selectedPro pro) {
    ...
    public ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_recyle_products , null , false);
    ...
    public interface selectedPro {

        void selectedPro (Products p1);
...
//        tv_available_quantity_data = itemView.findViewById(R.id.custom_tv_available_quantity_data);
            ...
            itemView.findViewById(R.id.recycle_products_btn_edit).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
//                    Edit_Search_Result edit = new Edit_Search_Result();
//                    edit.gotoActivity();
                    Toast.makeText(context , "Hi" , Toast.LENGTH_LONG).show();

                    pro.selectedPro(products.get(getAdapterPosition()));
                }
            });
